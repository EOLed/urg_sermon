<?php
class SermonPlayerComponent extends Object {
    var $controller = null;
    var $settings = null;
    ...
    function build($widget_id) {
        ...
        CakeLog::write("debug", "sermon for sermon player widget: " . Debugger::exportVar($sermon, 3));
        CakeLog::write("debug", "attachments for sermon player widget: " . 
