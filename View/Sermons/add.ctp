...
<?php echo $this->Form->create('Sermon'); ?>
    ...
    <div class="row">
        <div class="span6">
            <?php echo $this->Markdown->input('Sermon.description', array("preview" => "sermon-description-preview",
                                                                          "label"=>__("Description"), 
                                                                          "rows"=>"8"));?>
        </div>
        <div id="sermon-description-preview" class="span6 markdown-preview"></div>
    </div>
    <div class="row">
        <div class="span6">
            <?php echo $this->Markdown->input('Post.content', array("preview" => "sermon-notes-preview",
                                                                    "label"=>__("Notes"), 
                                                                    "rows"=>"20")); ?>
        </div>
        <div id="sermon-notes-preview" class="span6 markdown-preview"></div>
    </div>
    <div class="row form-actions">
        <div class="span12">
            <?php echo $this->Form->end(array("label" => __('Upload Sermon'),
