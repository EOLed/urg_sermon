    ...
    <div class="row">
        <div class="span6">
            <?php echo $this->Markdown->input('Sermon.description', array("preview" => "sermon-description-preview",
                                                                          "label"=>__("Description"), "rows"=>"8")); ?>
        </div>
        <div class="span6 markdown-preview" id="sermon-description-preview"></div>
    </div>
    <div class="row">
        <div class="span6">
        ...
        <div class="span6 markdown-preview" id="sermon-notes-preview"></div>
    </div>
